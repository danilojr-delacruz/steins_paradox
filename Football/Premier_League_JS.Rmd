...
legend(2.6,3.3, legend = c("MC.JS", "True Value'", "MLE"), pch = c(16,15,17), col = c("blue", "blue", "blue"))
...
```
average error change vector for improvements upon MLE
```{r}
error = abs(table$`MLE SSE` - table$`Adapt. JS Error`)
error
sum(error*(1-table$`Improvement Adapt. JS`))/14
